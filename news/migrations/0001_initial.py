...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsSummary'
        db.create_table(u'news_newssummary', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('max_stories', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('news_details_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'])),
        ))
    ...
    models = {
        ...
        u'news.newssummary': {
            ...
            'max_stories': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'news_details_page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']"})
        },
        u'news.story': {
